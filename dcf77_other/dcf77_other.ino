...
// Port 2 DIO = Arduino Pin 5   hier Pulseingang
#define DCF_PULSE_PIN 5
// Port 2 AIO = Arduino Pin 15   hier Reset für DCF
#define DCF_RESET_PIN 15

// the on-board led will track the pulse value
// Port 4 DIO = Arduino Pin 7   hier Reset für DCF
