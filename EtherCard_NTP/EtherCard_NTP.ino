...
prog_char ntp0[] PROGMEM = "ntp.ptbtime1.ptb.de";
prog_char ntp1[] PROGMEM = "ntp.ptbtime2.ptb.de";
prog_char ntp2[] PROGMEM = "ntp.ptbtime3.ptb.de";
prog_char ntp3[] PROGMEM = "ntp.cis.strath.ac.uk";
prog_char ntp4[] PROGMEM = "clock01.mnuk01.burstnet.eu";
prog_char ntp5[] PROGMEM = "time-a.timefreq.bldrdoc.gov";
  ...
  // Main processing loop now we have our addresses
    ...
    if( lastUpdate + 30000L < millis() ) {
      ...
      */
        ...
        ether.ntpRequest(pbt_1, clientPort);
