...
static void forwardToTCP () {
  static byte destIp[] = { 192,168,115,124 }; // UDP multicast address
  char buf[10];
  
  collPos = 0;
  collectStr(0x0000, "JeeTCP");
  ...
  byte fd2 = buf2.create();
    buf2.prepare(PSTR("a $S b $F c $D d $H e"),
