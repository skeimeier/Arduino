...
const int ledROT = 9;      // the pin that the LED is attached to
const int ledGN = 13;      // the pin that the LED is attached to
const int tast = 2;      // the pin that the LED is attached to
const int analog = 0;      // the pin that the LED is attached to
unsigned int pot;
boolean state;
